...
puts "Rodando........."
at1 = Activity.new(title: "bar do Bolinha", category: "bar", address: "rua não sei")
...
at2 = Activity.new(title: "bar do zé", category: "bar", address: "rua talvez alguma")
file = URI.open("https://source.unsplash.com/random")
...
at3 = Activity.new(title: "vintão", category: "restaurante", address: "av paulista")
file = URI.open("https://source.unsplash.com/random")
...
at4 = Activity.new(title: "MC", category: "Morte", address: "rua rua rua")
file = URI.open("https://source.unsplash.com/random")
